...
public final class PhoneAuthVC<ViewModel>: TFBaseViewController, AuthVCType where ViewModel: AuthViewModelType {
  ...
  private lazy var activityIndicator = UIActivityIndicatorView().then {
    $0.style = .medium
    $0.color = DSKitAsset.Color.neutral50.color
  ...
  public override func bindViewModel() {
    ...
    output.error
      .drive(with: self, onNext: { owner, error in
        ...
        owner.codeInputTextField.text = ""
        owner.blurView.alpha = 0
        owner.successPopup.isHidden = true
