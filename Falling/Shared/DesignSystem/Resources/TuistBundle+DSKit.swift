...
/// Since DSKit is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "DSKit_DSKit"
    var candidates = [
    ...
    fatalError("unable to find bundle named DSKit_DSKit")
}()
