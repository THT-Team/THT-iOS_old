...
public class TFTextField: UIControl, TFFieldProtocol {
  ...
  public var textColor: UIColor = DSKitAsset.Color.neutral50.color {
    didSet {
      self.textField.textField.textColor = textColor
    }
  }

  public var font: UIFont = .thtH3Sb {
    didSet {
      self.textField.textField.font = font
    }
  }
